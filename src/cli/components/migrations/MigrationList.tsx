...
export function MigrationList({ migrations, selectedIndex, theme }: MigrationListProps): React.JSX.Element {
  ...
  return (
    <Box flexDirection="column" borderStyle="single" borderColor={theme.colors.border} paddingX={1} minHeight={VIEWPORT_HEIGHT + 2}>
